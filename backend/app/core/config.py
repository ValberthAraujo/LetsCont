...
def parse_cors(v: Any) -> list[str] | str:
    ...
    # Accept list inputs or JSON-style string inputs unchanged
...
class Settings(BaseSettings):
    ...
    # Optional override to support alternative backends (e.g., SQLite) in local dev
    ...
    def SQLALCHEMY_DATABASE_URI(self) -> str:
        ...
        # Default to Postgres DSN
        from pydantic import PostgresDsn  # local import to avoid type import above
    ...
    # Display name for the From header (should be plain text, not an email)
